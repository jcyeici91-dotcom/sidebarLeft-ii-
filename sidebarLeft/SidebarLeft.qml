...
Scope { // Scope
    ...
    Loader {
        ...
        sourceComponent: PanelWindow { // Window
            ...
            color: "transparent" // La ventana base es transparente
            ...
            Rectangle {
                ...
                // [MODIFICADO AQUÍ] Usamos el color del tema pero con 0.65 de opacidad para el blur
                color: Qt.rgba(Appearance.colors.colLayer0.r, Appearance.colors.colLayer0.g, Appearance.colors.colLayer0.b, 0.65)
    ...
    Loader {
        ...
        sourceComponent: FloatingWindow {
            ...
            Rectangle {
                ...
                anchors.fill: parent
                // [MODIFICADO AQUÍ TAMBIÉN] Para el modo flotante
                color: Qt.rgba(Appearance.colors.colLayer0.r, Appearance.colors.colLayer0.g, Appearance.colors.colLayer0.b, 0.65)
